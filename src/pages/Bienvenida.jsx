...
const LOGO_URL = 'https://media.base44.com/images/public/6a5439e220ad1917feecf7ce/18b82ecc9_WhatsAppImage2026-07-12at232202.jpeg';
...
export default function Bienvenida() {
  ...
  const elegirProductor = async () => {
    setGuardando(true);
    try {
      await base44.functions.invoke('asignarRol', { role: 'usuario' });
      await checkUserAuth();
  ...
  const confirmarCamionero = async () => {
    ...
    setGuardando(true);
    try {
      await base44.functions.invoke('asignarRol', { role: 'chofer' });
      await base44.entities.Camion.create({
        ...datosCamion,
